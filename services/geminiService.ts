...
export const generateDetailedAnalysis = async (
  ...
  const prompt = `
    ...
    **ÖNEMLİ:** Mektup sadece "başarabilirsin" diyen boş bir motivasyon metni OLMAMALI. 
    1. Rehber öğretmen olarak tespit ettiğin teknik eksikleri (süre, dikkat vb.) mektuba yedir.
    2. En önemlisi, tespit ettiğin **Konu Temelli Yol Haritasını (Eksik Konuları)** mektubun içinde cümlelere dökerek ödev ver.
    ...
    **FORMAT VE YAPI KURALLARI:**
    ...
    3. TEKNİK REHBERLİK VE SOMUT KONU HEDEFLERİ (KRİTİK):
       - Rehber Öğretmen Görüşü niteliğindeki teknik analizlerini mektuba yedir.
       - **EN ÖNEMLİSİ:** Öğrencinin eksiği olan spesifik konuları (Konu Temelli Yol Haritası) mektubun içinde cümlelere dök.
       - Örnek: "Bu hafta senden özellikle Matematikte 'Çarpanlar ve Katlar' konusuna, Türkçede ise 'Sözel Mantık' sorularına odaklanmanı istiyorum," gibi nokta atışı konu isimleri vererek ödevlendir.
